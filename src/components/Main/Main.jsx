...
function Main({wordlist, isLoaded}, {index=0}) {
...
<Card handleScoreState={handleScoreState} nextCard={nextCard} setFlip={setFlip} flip={flip} handleFlipState={handleFlipState} tags={wordlist[cardIndex].tags} english={wordlist[cardIndex].english} russian={wordlist[cardIndex].russian} transcription={wordlist[cardIndex].transcription}/>
